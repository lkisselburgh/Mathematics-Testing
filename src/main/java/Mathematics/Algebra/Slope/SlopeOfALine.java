...
public class SlopeOfALine {
    ...
    public static double slope(double x1, double y1, double x2, double y2) {
        double slope = 0;
        if(x2 - x1 == 0d){
                System.out.println("This is a vertical line with no slope, also known as an Infinity Slope or Undefined Slope");
        }else {
                //Calculate the slope of a line
                slope = (y2 - y1) / (x2 - x1);
                System.out.println("The slope of your line is "+ slope);
        }
        return slope;
    }
}
